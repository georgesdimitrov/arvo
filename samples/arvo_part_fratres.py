...
# Set reference scale for inversion/transposition operations
reference_scale = scale.ConcreteScale(
    pitches=["A4", "B-4", "C#5", "D5", "E5", "F5", "G5"]
)

# Create the complete M-voice
...
# Create the T-voice and the secone M-voice
t_chord = ["A", "C", "E"]
...
# Merge streams and add time signatures
